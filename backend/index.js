...
mongoose
  .connect(process.env.DB_CONNECTION || config.connectionString, {
...
app.get("/get-user", authenticateToken, async (req, res) => {
  ...
  return res.json({ user: isUser, message: "Data Fetch Successfull" });
});
...
app.post("/add-travel-story", authenticateToken, async (req, res) => {
  ...
  //   Convert visitedData from milleseconds to Date Object
  ...
  try {
    ...
    fs.unlink(filePath, (err) => {
      if (err) {
        ...
        // if you dont want to treat this as critical error
      }
    });
